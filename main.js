...
const ratiosMap = [
    ...
    {name: "m2", number: "1", enabled: true, ratio: 16 / 15},
    {name: "M2", number: "2", enabled: true, ratio: 9 / 8},
    {name: "m3", number: "3", enabled: true, ratio: 6 / 5},
    {name: "M3", number: "4", enabled: true, ratio: 5 / 4},
    {name: "P4", number: "5", enabled: true, ratio: 4 / 3},
    {name: "A4", number: "6", enabled: true, ratio: 45 / 32},
    {name: "P5", number: "7", enabled: true, ratio: 3 / 2},
    {name: "m6", number: "8", enabled: true, ratio: 8 / 5},
    {name: "M6", number: "9", enabled: true, ratio:  5 / 3},
    {name: "m7", number: "10",  enabled: true, ratio:  16 / 9},
    {name: "M7", number: "11",  enabled: true, ratio:  15 / 8}
]
